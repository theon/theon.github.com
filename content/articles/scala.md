 ...
 * Autogenerated friendly toString() - displays Class names and all the class fields
...
Note how only getter methods are generated, not setter methods. This is because Scala promotes the use of immutable objects (hence the copy method), however if you do want to create a mutable case class with getters, you can use the `var` keyword:
...
For constructor and method arguments you can specify defaults:
    ...
    > class Animal(kind:String, sound="Woof")
    > new Animal("Dog")
